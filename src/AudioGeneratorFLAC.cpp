...
bool AudioGeneratorFLAC::begin(AudioFileSource *source, AudioOutput *output) {
  ...
  FLAC__StreamDecoderInitStatus ret =
      FLAC__stream_decoder_init_stream(flac, _read_cb, _seek_cb, _tell_cb, _length_cb, _eof_cb, _write_cb, _metadata_cb,
                                       _error_cb, reinterpret_cast<void *>(this));
...
bool AudioGeneratorFLAC::isRunning() { return running; }
