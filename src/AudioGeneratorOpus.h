...
class AudioGeneratorOpus : public AudioGenerator {
 ...
 protected:
  ...
  static opus_int64 OPUS_tell(void *_stream) { return static_cast<AudioGeneratorOpus *>(_stream)->tell_cb(); }
  static int OPUS_close(void *_stream) { return static_cast<AudioGeneratorOpus *>(_stream)->close_cb(); }
