...
const uint16_t *Pt3Emu::sGetNoteTable(uint8_t tableID, uint8_t subVersion) {
  static const uint16_t TABLE_ST[96] PROGMEM = {
  ...
  static const uint16_t TABLE_PT[2][96] PROGMEM = {
  ...
  const bool v4 = subVersion >= 4;

  if (tableID == 0)
    return TABLE_PT[v4];

  static const uint16_t TABLE_ASM[2][96] PROGMEM = {
  ...
  static const uint16_t TABLE_REAL[2][96] PROGMEM = {
  ...
  return TABLE_REAL[v4];
}

const Pt3Emu::VolumeTable *Pt3Emu::sGetVolumeTable(uint8_t subVersion) {
  static const uint8_t TABLE[2][16][16] PROGMEM = {
